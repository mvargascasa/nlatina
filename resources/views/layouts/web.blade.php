          ...
          <div class="d-flex flex-grow-1">
              <span class="w-100 d-lg-none d-block">
                  <a class="navbar-brand" href="{{route('web.index')}}">
                      <img src="{{asset('img/marca-notaria-latina.webp')}}" width="140px" height="30px" alt="">
                    </a>
              </span>
    ...
    <div class="container">
        <div class="row ">
            <div class="col-12 col-sm-6 col-md-3 pt-4">
                <img width="150px" height="35px" src="{{asset('img/marca-notaria-latina.webp')}}" alt="Logo Notaria Latina">
