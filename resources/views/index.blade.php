        ...
        <div class="carousel-item active"  style="background:rgba(2, 2, 2, 0.5);">
          ...
          <div class="carousel-caption">
              ...
              <div id="locations" class="row" style="margin-left: 10%; margin-right: 10%">
                <div class="col-sm-4 border-right"><i class="fas fa-map-marker-alt"><a style="color: #ffffff; text-decoration: none" href="{{ route('web.oficina.newjersey') }}"></i> Oficinas New Jersey</div></a>
                <div class="col-sm-4 border-left border-right"><i class="fas fa-map-marker-alt"><a style="color: #ffffff; text-decoration: none" href="#"></i> Oficinas New York</a></div>
