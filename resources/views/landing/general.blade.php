...
<footer class="text-center navfoot text-white py-3"> Copyright ©2020 Notaria Latina. All rights reserved. <a class="text-white font-weight-bold" href="{{ route('web.politicas') }}">Politicas de Privacidad</a> </footer>
