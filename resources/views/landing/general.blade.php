...
<div class="d-flex justify-content-center align-items-center px-3 py-1 text-white font-weight-bold" style="position: fixed; bottom: 0px; right: 10px; background-color: #128C7E; border-radius: 10px 10px 0px 0px">
