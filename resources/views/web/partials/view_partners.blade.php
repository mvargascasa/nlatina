        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            {!! Form::open(['route' => 'web.showallpartners', 'method' => 'POST', 'id' => 'formSearchPartnersAfter']) !!}
                <div id="rowFiltros" class="row d-flex justify-content-center" style="margin-left: 25%; margin-right: 23%">
                    <div class="col-4 col-lg-3" style="margin-left: -27px;">    
                        <div class="form-group">
                            <select class="form-control selects" name="country" id="country" onchange="loadStates();" style="border: none; border-radius: 0px; height: 31px; font-size: 14px; background-color: #ffffff">
                    ...
                    <div class="col-4 col-lg-3" style="margin-left: -27px;">
                        <div class="form-group">
                            <select class="form-control selects" name="state" id="stateSelect" style="border: none; border-radius: 0px; height: 31px; font-size: 14px"> 
                    ...
                    <div class="col-4 col-lg-3" style="margin-left: -27px;">
                        <div class="form-group">
                            <select class="form-control selects" name="specialty" id="specialty" style="border: none; border-radius: 0px; height: 31px; font-size: 14px">
