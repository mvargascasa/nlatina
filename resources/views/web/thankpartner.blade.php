...
<head>
  ...
  <title>Partners Notaria Latina - Suscripción</title>
...
<section class="container" style="min-height: 85vh;">
    <div class="row p-4 p-md-5">
        ...
        <div class="col-12 col-md-5 text-right">
            <img id="imghelp" class="img-fluid p-4" src="{{asset('img/thankpartner.jpg')}}" alt="">
        </div>
        <div class="col-md-7 text-center">

            <h3 class="font-italic font-weight-bold p-2">Por suscribirte con nosotros.</h3>
            <p class="lead">En breve te contactaremos.</p>
            <a class="btn btn-warning" href="{{ route('web.partners') }}">Regresar a la página</a>

            <div class="row">
                <div class="col-sm-6">
                    <h3 class="font-italic font-weight-bold pt-4">Servicios que ofrece Notaria Latina</h3>
                ...
                <div class="col-sm-6">
                    <h3 class="font-italic font-weight-bold pt-4">Conoce nuestra empresa</h3>
                    <p class="lead">Ingresando al siguiente enlace</p>
                    <a href="{{ route('web.nosotros') }}">Notaria Latina</a>
                </div>
            </div>
        </div>
    </div>
