        ...
        <div class="col-12 col-sm-8 col-md-8 pb-4">
          ...
          <h4 class="p-1">Visite nuestras oficinas.</h4>
            ...
            <div class="row py-4">
                ...
                <div class="col-12 col-sm-6">
                  <a target="_blank" href="https://g.page/notariapublicalatina"><img class="img-fluid" src="{{ asset('img/map-ny-contact.webp') }}" alt="Notaria Latina en New York - Poderes, Apostillas, Traducciones"></a>
                </div>
            ...
            <div class="row py-4">
              ...
              <div class="col-12 col-sm-6">
                <a target="_blank" href="https://g.page/r/CVNRV-zNuJiZEAE"><img class="img-fluid" src="{{ asset('img/map-nj-contact.webp') }}" alt="Notaria Latina en New Jersey - Poderes, Apostillas, Traducciones"></a>
              </div>
...
<script>
    window.addEventListener('load', (event) => {
        document.getElementById('prisection').style.backgroundImage = "url('img/contactenos.jpg')";
    });
  </script>
@endsection
