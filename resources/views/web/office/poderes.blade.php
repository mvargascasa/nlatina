...
<meta name="keywords"           content="poder notarial, carta poder, como hacer carta poder, carta poder que es, carta poder {{ $data['office'] }}, poder notarial {{ $data['office'] }}, que es un poder, que es una carta poder, para que sirve una carta poder, tipos de carta poder en {{ Str::lower($data['office']) }}, requisitos para carta poder en {{ Str::lower($data['office']) }}, notarizar carta poder en {{ Str::lower($data['office']) }}, notarizar carta poder en {{ Str::lower($data['office']) }}, apostillar carta poder en {{ Str::lower($data['office']) }}, donde puedo notarizar una carta poder en {{ Str::lower($data['office']) }}, donde puedo apostillar una carta poder en {{ Str::lower($data['office']) }}, donde tramitar un poder" />
