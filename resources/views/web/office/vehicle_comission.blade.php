...
@section('content')
<section id="prisection" style="background-size: cover;background-position: left top; background-repeat: no-repeat; background-image: url('{{ asset('img/vehicle_commission.webp') }}')">
    <div>
  ...
  <div class="container pt-4">
            <h2 class="px-2 py-1" style="font-size: 1.6rem; border-left: 3px solid #FFBE3E;">¿Qué documentos necesita para la obtención de su licencia?</h2>
            ...
            <h2 class="px-2 py-1" style="font-size: 1.6rem; border-left: 3px solid #FFBE3E;">¿Aceptará la MVC mis documentos si están en un idioma que no sea el inglés?</h2>
            <p class="text-muted text-justify">
            ...
            <h2 class="px-2 py-1" style="font-size: 1.6rem; border-left: 3px solid #FFBE3E;">¿Cuánto cuesta y cómo se puede pagar?</h2>
            <p class="text-muted">
            ...
            <h2 class="px-2 py-1" style="font-size: 1.6rem; border-left: 3px solid #FFBE3E;">¿Tuvo problemas con el trámite?</h2>
            <p class="text-muted text-justify">
