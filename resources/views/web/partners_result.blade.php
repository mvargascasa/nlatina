...
@endphp
    ...
    <meta name="keywords" content="abogados near me, abogados cerca de mi, abogados en {{strtolower($country_aux->name_country)}}, abogado en {{strtolower($country_aux->name_country)}}, abogados de {{strtolower($country_aux->name_country)}}, abogados migratorios {{strtolower($country_aux->name_country)}}, abogados de familia {{strtolower($country_aux->name_country)}}, abogados de familia en {{strtolower($country_aux->name_country)}}, abogados de divorcio {{strtolower($country_aux->name_country)}}, abogados de inmigracion {{strtolower($country_aux->name_country)}}, abogados de inmigracion en {{strtolower($country_aux->name_country)}}, abogados familiar {{strtolower($country_aux->name_country)}}, abogados familiar en {{strtolower($country_aux->name_country)}}">
