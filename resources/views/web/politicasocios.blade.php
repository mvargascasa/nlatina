...
<div class="container p-4 text-justify">
    <h1 dir="ltr"><strong>POL&Iacute;TICAS DE PRIVACIDAD Y COOKIES</strong></h1>
    <h3>PRIVACIDAD</h3>
    <p style="font-weight: bold">1. Uso, finalidad y régimen jurídico aplicable</p>
    <p>
    ...
    <p style="font-weight: bold">2. Destinatarios y categorías de Encargados del tratamiento</p>
    <p>
    ...
    <p style="font-weight: bold">3. Ejercicio de derechos del interesado</p>
    <p>
    ...
    <p style="font-weight: bold">4. Notaría Pública Latina como encargado del tratamiento</p>
    <p>
    ...
    <p style="font-weight: bold">5. Publicación de opiniones</p>
    <p>
    ...
    <h3>COOKIES</h3>
    <p style="font-weight: bold">1. Uso de cookies en el Sitio Web Notaría Pública Latina</p>
    <p>
    ...
    <p style="font-weight: bold">2. Definición de las cookies</p>
    <p>
    ...
    <p style="font-weight: bold">3. ¿Qué tipos de cookies existen?</p>
    <p>
    ...
    <p style="font-weight: bold">4. Uso de cookies por Notaría Pública Latina</p>
    <p>Notaría Pública Latina informa al Usuario que el presente sitio web utiliza cookies para las siguientes finalidades:</p>
    <ul>
        <li>
    ...
    <p style="font-weight: bold">5. ¿Qué tipos de cookies utiliza este Sitio Web?</p>
    <p>
    ...
    <p style="font-weight: bold">6. ¿Puedo configurar la instalación de cookies en mi navegador?</p>
    <p>
    ...
    <p style="font-weight: bold">7. ¿Cómo puede el Usuario bloquear o eliminar las cookies que utiliza este sitio web?</p>
    <p>
