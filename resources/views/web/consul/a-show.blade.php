...
@section('header')
    ...
    <meta name="keywords"           content="consulado de {{Str::lower($consul->country)}}, cita consular {{ Str::lower($consul->country) }}, migrante de {{ Str::lower($consul->country) }}, tramite consular {{ Str::lower($consul->country) }}, tramites consulares de {{ Str::lower($consul->country) }} en new york, consulado de {{ Str::lower($consul->country) }} en new york, consulado de {{Str::lower($consul->country)}} en ny, consulado {{ $consul->demonym }}, consulado {{ $consul->demonym }} en ny, consulado {{ $consul->demonym }} en new york, consulado de {{ Str::lower($consul->country)}} en estados unidos, consulado {{ $consul->demonym }} en estados unidos, trámites consulares en new york, embajada de {{ Str::lower($consul->country) }} en new york" />
